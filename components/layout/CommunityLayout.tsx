...
import { Ambassador } from '@/types/pages/community/Community';
...
// import BoardMembersList from '../../config/TSC_BOARD_MEMBERS.json';
...
function UserInfo({ user }: TSCUser) {
  return (
    ...
    >
      ...
      {"repos" in user && <div className='flex flex-wrap items-center gap-1'>
        Maintainer of:
...
export default function CommunityLayout({
  ...
  const relevantMembersList: Tsc[] | Ambassador[] = (membership === Membership.TSC ? TSCMembersList : []) || [] ;
  ...
  return (
    <GenericLayout title={isTSCMembership ? 'Technical Steering Committee' : 'Board Committee'} description={description} image={image} wide>
      <div className='relative mx-auto px-4 py-12 sm:px-6 lg:px-8'>
        {children}
        {isTSCMembership && <div className='mt-8'>
          <NewsletterSubscribe
            type='TSC Voting'
